...
public class Square {
	...
	/**
	 * move Square in the given direction if possible Square will not move if
	 * direction is blocked, or Square is unable to move If attempt to move DOWN
	 * and it can't, the Square is frozen and cannot move anymore
	 * 
	 * @param direction
