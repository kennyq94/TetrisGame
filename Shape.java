 ...
 * 
 * All pieces are made up of 4 squares in the following configuration Sq<br>
 * Sq<br>
 * Sq Sq<br>
 * 
...
public abstract class Shape {
	...
	protected Square[] square; // the Squares that make up this piece protected
								// for use in different classes
	...
	/**
	 * Create a Shape piece. See class description for actual location of r and
	 * c
	 * 
	 * @param r
	...
	public Shape(int r, int c, Grid g) {
		...
		ableToMove = true;
		// moved all the specification of LShape to own child class
		// now Shape is abstract parent class
	}
	...
	/**
	 * Move the piece if possible Freeze the piece if it cannot move down
	 * anymore
	 * 
	 * @param direction
	 *            the direction to move
	 * @throws IllegalArgumentException
	 *             if direction is not Square.DOWN, Square.LEFT, or Square.RIGHT
	 */
	...
	/*
	 * @abstract method for rotate with protected variable rotation at zero for
	 * rotation counter in each shape rotation method
	 */
